...
export const SelectionSort = ({ initialArray, initialSize = 30 }: SelectionSortProps) => {
    ...
    for (let i = 0; i < n - 1; i++) {
      ...
      for (let j = i + 1; j < n; j++) {
        ...
        steps.push({
          ...
          active: [i],
          description: `Finding minimum in unsorted portion. Current min: ${tempArr[minIdx]}`,
        });
      ...
      if (minIdx !== i) {
        ...
        steps.push({
          ...
          description: `Swapping ${tempArr[minIdx]} with ${tempArr[i]}`,
        });
      }
    }
